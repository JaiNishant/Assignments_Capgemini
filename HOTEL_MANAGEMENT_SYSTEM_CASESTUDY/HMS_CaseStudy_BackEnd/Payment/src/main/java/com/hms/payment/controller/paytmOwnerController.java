...
@CrossOrigin("*")
@Controller
public class paytmOwnerController {
	...
	@PostMapping(value = "/pgredirectown")
	public ModelAndView getRedirectown(@RequestParam(name = "CUST_ID") String customerId,
	...
	@PostMapping(value = "/pgresponseown")
	public String getResponseRedirectown(HttpServletRequest request, Model model) {
